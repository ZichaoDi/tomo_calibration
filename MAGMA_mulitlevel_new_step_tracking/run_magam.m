...
params.NH = 1;         % Number of iterations for the coarse-level solver
params.T = 200;         % Max iterations for the main MAGMA loop
params.mu = 1e-2;       % NEW: Smoothing parameter for the gradient calculation
params.c = 0.1;         % Armijo line search parameter, a typical value
params.tau = 0.5;           % Line search shrinkage factor (e.g., 0.95)
params.tolerance = 1e-1; % Convergence tolerance for ||D(x)||
