...
maxIterA = 250; % 100 is not enough
regWt = 1e-3; % 1.3e05 or 1e-5 similar or 1e-8*max(WGT(:))/LNormalizer^2;  1e-6 to 1e-8 both good for phantom, use 1e-8 for brain, especically WGT is scaled to maximum of 1 not 40
