...
%%
% regspace2_lsqr = linspace(0,20,21)';
...
%% 8 (best) for lsqr
parameters = struct('maxIt',k','kappaB',1,'kappa',1,'iftrun',0,'tau',0,'reg',8,'eta',eta,'nl',nl);
...
axis([0 12 0.118 0.121])
set(gca,'fontsize',16)
yticks([0.118,0.119,0.120,0.121])
...
%%
% regspace2_nnr = linspace(0,20,21)';
...
%% reg parameter equal to 7 (best) for FLSQR-NNR
optnnr.reg = 7;
