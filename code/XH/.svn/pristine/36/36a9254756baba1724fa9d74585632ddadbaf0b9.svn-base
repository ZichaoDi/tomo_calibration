...
% 2019.02.12: need to change the scaleBegin from 1e2 to 1e1; %1e2 in t
...
sampleNameAll = {'checkboard'}; % choose from {'Phantom', 'Brain', ''Golosio', 'circle', 'checkboard', 'fakeRod'}; not case-sensitive
